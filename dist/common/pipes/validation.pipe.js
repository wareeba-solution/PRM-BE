...
var ValidationPipe = function () {
    ...
    var ValidationPipe = _classThis = /** @class */ (function () {
        function ValidationPipe_1() {
            this.logger = new common_1.Logger(ValidationPipe.name);
        }
        ValidationPipe_1.prototype.transform = function (value, metadata) {
            return __awaiter(this, void 0, void 0, function () {
                var metatype, object, errors, formattedErrors;
                    ...
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            if (errors.length > 0) {
                                ...
                                this.logger.warn("Validation failed: ".concat(JSON.stringify(formattedErrors)));
        ...
        ValidationPipe_1.prototype.toValidate = function (metatype) {
            var types = [String, Boolean, Number, Array, Object];
            return !types.includes(metatype);
        };
        ValidationPipe_1.prototype.formatErrors = function (errors) {
            var _this = this;
            return errors.reduce(function (acc, error) {
                // Handle nested validation errors
                if (error.children && error.children.length > 0) {
                    acc[error.property] = _this.formatErrors(error.children);
                }
