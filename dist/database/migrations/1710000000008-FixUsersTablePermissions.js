...
exports.FixUsersTablePermissions1710000000008 = void 0;
class FixUsersTablePermissions1710000000008 {
    async up(queryRunner) {
        ...
        await queryRunner.query(`
            ...
            END $$;
        `);
        // Now check if the permissions column exists, and add it if it doesn't
        await queryRunner.query(`
            DO $$ 
            BEGIN
...
exports.FixUsersTablePermissions1710000000008 = FixUsersTablePermissions1710000000008;
//# sourceMappingURL=1710000000008-FixUsersTablePermissions.js.map