...
var AppointmentsService = function () {
    ...
    var AppointmentsService = _classThis = /** @class */ (function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            updater = _a.sent();
                            if (!updater) {
                                throw new common_1.NotFoundException("User with ID ".concat(data.updatedBy, " not found"));
                            }
        ...
        AppointmentsService_1.prototype.confirmAppointment = function (id, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.confirm(id, data)];
                });
            });
        };
