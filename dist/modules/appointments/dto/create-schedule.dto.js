...
var CreateScheduleDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CreateScheduleDto() {
                ...
                this.dayOfWeek = (__runInitializers(this, _doctorId_extraInitializers), __runInitializers(this, _dayOfWeek_initializers, void 0));
            ...
            CreateScheduleDto._OPENAPI_METADATA_FACTORY = function () {
                return { doctorId: { required: true, type: function () { return String; }, format: "uuid" }, dayOfWeek: { required: true, type: function () { return Number; }, minimum: 0, maximum: 6 }, workStart: { required: true, type: function () { return String; } }, workEnd: { required: true, type: function () { return String; } }, breakStart: { required: false, type: function () { return String; } }, breakEnd: { required: false, type: function () { return String; } }, defaultAppointmentDuration: { required: true, type: function () { return Number; }, minimum: 5 }, isActive: { required: false, type: function () { return Boolean; } }, settings: { required: false, type: function () { return ScheduleSettingsDto; } } };
            };
        ...
        (function () {
            ...
            _dayOfWeek_decorators = [(0, swagger_1.ApiProperty)({ description: 'Day of week (0=Sunday, 1=Monday, etc.)', example: 1 }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(0), (0, class_validator_1.Max)(6), (0, class_validator_1.IsNotEmpty)()];
            _workStart_decorators = [(0, swagger_1.ApiProperty)({ description: 'Work start time', example: '09:00' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _workEnd_decorators = [(0, swagger_1.ApiProperty)({ description: 'Work end time', example: '17:00' }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            ...
            _defaultAppointmentDuration_decorators = [(0, swagger_1.ApiProperty)({ description: 'Default appointment duration in minutes', example: 30 }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(5), (0, class_validator_1.IsNotEmpty)()];
