...
var AddressDto = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            AddressDto._OPENAPI_METADATA_FACTORY = function () {
                return { street: { required: false, type: function () { return String; }, maxLength: 100 }, city: { required: false, type: function () { return String; }, maxLength: 50 }, state: { required: false, type: function () { return String; }, maxLength: 50 }, postalCode: { required: false, type: function () { return String; }, maxLength: 20 }, country: { required: false, type: function () { return String; }, maxLength: 50 } };
            };
            return AddressDto;
        }()),
        (function () {
...
var EmergencyContactDto = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            EmergencyContactDto._OPENAPI_METADATA_FACTORY = function () {
                return { name: { required: true, type: function () { return String; }, maxLength: 100 }, relationship: { required: true, type: function () { return String; }, maxLength: 50 }, phone: { required: true, type: function () { return String; } }, address: { required: false, type: function () { return String; }, maxLength: 200 } };
            };
        ...
        (function () {
            ...
            _relationship_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(50)];
            _phone_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsPhoneNumber)(undefined)];
...
var AddUserDto = function () {
    ...
    return _a = /** @class */ (function () {
            function AddUserDto() {
                ...
                this.title = (__runInitializers(this, _phoneNumber_extraInitializers), __runInitializers(this, _title_initializers, void 0));
                ...
                this.languages = (__runInitializers(this, _certifications_extraInitializers), __runInitializers(this, _languages_initializers, void 0));
                this.preferences = (__runInitializers(this, _languages_extraInitializers), __runInitializers(this, _preferences_initializers, void 0));
            ...
            AddUserDto._OPENAPI_METADATA_FACTORY = function () {
                return { firstName: { required: true, type: function () { return String; }, minLength: 2, maxLength: 50 }, lastName: { required: true, type: function () { return String; }, minLength: 2, maxLength: 50 }, email: { required: true, type: function () { return String; }, maxLength: 100, format: "email" }, password: { required: true, type: function () { return String; }, minLength: 8, maxLength: 50, pattern: "/^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@$!%*?&])[A-Za-z\\d@$!%*?&]{8,}$/" }, role: { required: true, enum: require("../../users/enums/role.enum").Role }, phoneNumber: { required: false, type: function () { return String; } }, title: { required: false, type: function () { return String; }, maxLength: 100 }, department: { required: false, type: function () { return String; }, maxLength: 100 }, employeeId: { required: false, type: function () { return String; }, maxLength: 50 }, address: { required: false, type: function () { return require("./add-user.dto").AddressDto; } }, emergencyContact: { required: false, type: function () { return require("./add-user.dto").EmergencyContactDto; } }, licenseNumber: { required: false, type: function () { return String; }, maxLength: 50 }, specialization: { required: false, type: function () { return String; }, maxLength: 100 }, qualifications: { required: false, type: function () { return [String]; } }, certifications: { required: false, type: function () { return [String]; } }, languages: { required: false, type: function () { return [String]; } }, preferences: { required: false, type: function () { return ({ theme: { required: false, type: function () { return String; } }, notifications: { required: false, type: function () { return ({ email: { required: false, type: function () { return Boolean; } }, sms: { required: false, type: function () { return Boolean; } }, inApp: { required: false, type: function () { return Boolean; } } }); } }, timezone: { required: false, type: function () { return String; } }, language: { required: false, type: function () { return String; } } }); } }, metadata: { required: false, type: function () { return Object; } } };
            };
            return AddUserDto;
        }()),
        (function () {
            ...
            _password_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MinLength)(8), (0, class_validator_1.MaxLength)(50), (0, class_validator_1.Matches)(/^(?=.*[a-z])(?=.*[A-Z])(?=.*\d)(?=.*[@$!%*?&])[A-Za-z\d@$!%*?&]{8,}$/, {
            ...
            _phoneNumber_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsPhoneNumber)(undefined)];
            ...
            _emergencyContact_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.ValidateNested)(), (0, class_transformer_1.Type)(function () { return EmergencyContactDto; })];
            ...
            _specialization_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)(), (0, class_validator_1.MaxLength)(100)];
