...
var ContactAddressDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function ContactAddressDto() {
                this.street = __runInitializers(this, _street_initializers, void 0);
                this.firstName = __runInitializers(this, _street_extraInitializers);
                this.street2 = __runInitializers(this, _street2_initializers, void 0);
        ...
        (function () {
            ...
            _city_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(50)];
            _state_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(50)];
            _postalCode_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(20)];
            _country_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(50)];
...
var EmergencyContactDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            ...
            EmergencyContactDto._OPENAPI_METADATA_FACTORY = function () {
        ...
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _name_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MinLength)(2), (0, class_validator_1.MaxLength)(50)];
            _relationship_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MaxLength)(50)];
            _phone_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsPhoneNumber)(), (0, class_validator_1.IsNotEmpty)()];
...
var MedicalInfoDto = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            MedicalInfoDto._OPENAPI_METADATA_FACTORY = function () {
...
var InsuranceInfoDto = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            InsuranceInfoDto._OPENAPI_METADATA_FACTORY = function () {
                return { provider: { required: true, type: function () { return String; } }, policyNumber: { required: true, type: function () { return String; } }, groupNumber: { required: false, type: function () { return String; } }, validFrom: { required: true, type: function () { return Date; } }, validTo: { required: true, type: function () { return Date; } } };
            };
        ...
        (function () {
            ...
            _policyNumber_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)()];
            _groupNumber_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _validFrom_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsDate)(), (0, class_transformer_1.Type)(function () { return Date; })];
            _validTo_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsDate)(), (0, class_transformer_1.Type)(function () { return Date; })];
...
var CommunicationPrefsDto = function () {
    var _a;
    ...
    return _a = /** @class */ (function () {
            function CommunicationPrefsDto() {
                this.allowEmail = __runInitializers(this, _allowEmail_initializers, true);
                this.allowSMS = (__runInitializers(this, _allowEmail_extraInitializers), __runInitializers(this, _allowSMS_initializers, true));
                this.allowWhatsApp = (__runInitializers(this, _allowSMS_extraInitializers), __runInitializers(this, _allowWhatsApp_initializers, true));
                this.allowPush = (__runInitializers(this, _allowWhatsApp_extraInitializers), __runInitializers(this, _allowPush_initializers, true));
            ...
            CommunicationPrefsDto._OPENAPI_METADATA_FACTORY = function () {
                return { allowEmail: { required: true, type: function () { return Boolean; }, default: true }, allowSMS: { required: true, type: function () { return Boolean; }, default: true }, allowWhatsApp: { required: true, type: function () { return Boolean; }, default: true }, allowPush: { required: true, type: function () { return Boolean; }, default: true }, preferredLanguage: { required: false, type: function () { return String; } }, preferredContactTime: { required: false, type: function () { return String; } } };
            };
            return CommunicationPrefsDto;
        }()),
        (function () {
            var _metadata = typeof Symbol === "function" && Symbol.metadata ? Object.create(null) : void 0;
            _allowEmail_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsBoolean)()];
            _allowSMS_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsBoolean)()];
            _allowWhatsApp_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsBoolean)()];
            _allowPush_decorators = [(0, swagger_1.ApiProperty)(), (0, class_validator_1.IsBoolean)()];
...
var CreateContactDto = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            CreateContactDto._OPENAPI_METADATA_FACTORY = function () {
                return { firstName: { required: true, type: function () { return String; }, minLength: 2, maxLength: 50 }, lastName: { required: true, type: function () { return String; }, minLength: 2, maxLength: 50 }, email: { required: true, type: function () { return String; }, format: "email" }, phone: { required: true, type: function () { return String; } }, whatsapp: { required: false, type: function () { return String; } }, dateOfBirth: { required: true, type: function () { return Date; } }, gender: { required: true, enum: require("../enums/gender.enum").Gender }, maritalStatus: { required: false, enum: require("../enums/marital-status.enum").MaritalStatus }, address: { required: true, type: function () { return require("./create-contact.dto").ContactAddressDto; } }, emergencyContact: { required: true, type: function () { return require("./create-contact.dto").EmergencyContactDto; } }, medicalInfo: { required: false, type: function () { return require("./create-contact.dto").MedicalInfoDto; } }, insuranceInfo: { required: false, type: function () { return require("./create-contact.dto").InsuranceInfoDto; } }, communicationPrefs: { required: true, type: function () { return require("./create-contact.dto").CommunicationPrefsDto; } }, notes: { required: false, type: function () { return String; }, maxLength: 500 }, documents: { required: false, type: function () { return [String]; }, format: "uri" }, tags: { required: false, type: function () { return [String]; } }, groups: { required: false, type: function () { return [String]; } } };
            };
        ...
        (function () {
            ...
            _firstName_decorators = [(0, swagger_1.ApiProperty)({
                    ...
                    example: 'John',
                }), (0, class_validator_1.IsString)(), (0, class_validator_1.IsNotEmpty)(), (0, class_validator_1.MinLength)(2), (0, class_validator_1.MaxLength)(50)];
            ...
            _phone_decorators = [(0, swagger_1.ApiProperty)({
                    ...
                    example: '+1234567890',
                }), (0, class_validator_1.IsPhoneNumber)(), (0, class_validator_1.IsNotEmpty)()];
            ...
            _dateOfBirth_decorators = [(0, swagger_1.ApiProperty)({
            ...
            _address_decorators = [(0, swagger_1.ApiProperty)({
                ...
                }), (0, class_validator_1.ValidateNested)(), (0, class_transformer_1.Type)(function () { return ContactAddressDto; })];
            _emergencyContact_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Emergency contact information',
                }), (0, class_validator_1.ValidateNested)(), (0, class_transformer_1.Type)(function () { return EmergencyContactDto; })];
            _medicalInfo_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Medical information',
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.ValidateNested)(), (0, class_transformer_1.Type)(function () { return MedicalInfoDto; })];
            _insuranceInfo_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Insurance information',
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.ValidateNested)(), (0, class_transformer_1.Type)(function () { return InsuranceInfoDto; })];
            _communicationPrefs_decorators = [(0, swagger_1.ApiProperty)({
                    description: 'Communication preferences',
                }), (0, class_validator_1.ValidateNested)(), (0, class_transformer_1.Type)(function () { return CommunicationPrefsDto; })];
            ...
            _documents_decorators = [(0, swagger_1.ApiPropertyOptional)({
                    description: 'Document URLs',
                    type: [String],
                }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsUrl)({}, { each: true }), (0, class_validator_1.IsArray)()];
...
var CreateContactResponseDto = /** @class */ (function () {
    function CreateContactResponseDto() {
    }
    CreateContactResponseDto._OPENAPI_METADATA_FACTORY = function () {
        return { id: { required: true, type: function () { return String; } }, firstName: { required: true, type: function () { return String; } }, lastName: { required: true, type: function () { return String; } }, email: { required: true, type: function () { return String; } }, createdAt: { required: true, type: function () { return Date; } }, createdBy: { required: true, type: function () { return String; } } };
    };
