...
var AuthGuard = function () {
    ...
    var AuthGuard = _classThis = /** @class */ (function () {
        function AuthGuard_1(reflector, authService, jwtService, configService, usersService) {
            this.reflector = reflector;
            this.authService = authService;
            this.jwtService = jwtService;
            this.configService = configService;
            this.usersService = usersService;
            this.logger = new common_1.Logger(AuthGuard.name);
        }
        AuthGuard_1.prototype.canActivate = function (context) {
            return __awaiter(this, void 0, void 0, function () {
                var request, isPublic, token, payload, user, error_1, error_2;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 3:
                            ...
                            if (isPublic)
                                return [2 /*return*/, true];
                            this.logger.error('Token validation failed:', error_1);
                        ...
                        case 5:
                            ...
                            this.logger.error('Authentication error:', error_2);
        ...
        AuthGuard_1.prototype.extractTokenFromHeader = function (request) {
            var _a, _b;
