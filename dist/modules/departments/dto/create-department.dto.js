...
class CreateDepartmentDto {
    ...
    static _OPENAPI_METADATA_FACTORY() {
        return { name: { required: true, type: () => String }, description: { required: false, type: () => String }, parentDepartmentId: { required: false, type: () => String, format: "uuid" }, managerId: { required: false, type: () => String, format: "uuid" }, isActive: { required: false, type: () => Boolean, default: true }, contactEmail: { required: false, type: () => String }, contactPhone: { required: false, type: () => String }, workingHours: { required: false, type: () => String }, timezone: { required: false, type: () => String }, tags: { required: false, type: () => [String] }, metadata: { required: false, type: () => Object } };
    }
}
__decorate([
