...
var ErrorHandlerService = function () {
    ...
    var ErrorHandlerService = _classThis = /** @class */ (function () {
        ...
        ErrorHandlerService_1.prototype.notFound = function (entity, id) {
            throw new common_1.NotFoundException("".concat(entity, " with ID ").concat(id, " not found"));
        };
        ErrorHandlerService_1.prototype.badRequest = function (message) {
            throw new common_1.BadRequestException(message);
        };
        ErrorHandlerService_1.prototype.conflict = function (message) {
