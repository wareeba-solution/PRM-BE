...
var TemplateService = function () {
    ...
    var TemplateService = _classThis = /** @class */ (function () {
        function TemplateService_1(templateRepository) {
            this.templateRepository = templateRepository;
        }
        TemplateService_1.prototype.findById = function (id, organizationId) {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            template = _a.sent();
                            if (!template) {
                                throw new common_1.NotFoundException("Template with ID ".concat(id, " not found"));
                            }
        ...
        TemplateService_1.prototype.processTemplate = function (template, data) {
