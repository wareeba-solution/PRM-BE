...
export const typeOrmConfig = async (): Promise<TypeOrmModuleOptions> => {
    ...
    return {
        ...
        entities: ['dist/**/*.entity.js', 'dist/entities/UserSpecialization.js'], // Include new entity
...
export const typeOrmConfigSync = (): DataSourceOptions => {
    ...
    return {
        ...
        synchronize: dbConfig.synchronize,
        logging: dbConfig.logging,
        entities: ['src/**/*.entity.ts', 'src/entities/UserSpecialization.ts'], // Include new entity
